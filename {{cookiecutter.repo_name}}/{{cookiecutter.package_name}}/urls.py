...
urlpatterns = [
    ...
    # Admin URLs.
    url(r'^admin/password_change/$', password_change, {'password_change_form': CMSPasswordChangeForm}, name='password_change'),
    url(r'^admin/password_change/done/$', password_change_done, name='password_change_done'),
