# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-03 11:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('per_page', models.PositiveIntegerField(blank=True, default=10, null=True, verbose_name='people per page')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(blank=True, help_text='This is their formal title, not their job title.', max_length=20, null=True)),
                ...
                ('bio', cms.models.fields.HtmlField(blank=True, null=True)),
                ('email', models.CharField(blank=True, max_length=100, null=True)),
                ('linkedin', models.CharField(blank=True, help_text="This can either be a username (e.g. @person) or a full URL; it'll be normalised to a URL on save.", max_length=100, null=True, verbose_name='LinkedIn')),
