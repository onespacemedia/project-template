    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('closing_date', models.DateField(blank=True, help_text='The date after which this career should no longer be listed on the site. If you leave this empty, it will never be de-listed.', null=True)),
                ('location', models.CharField(blank=True, max_length=256, null=True)),
                ('summary', models.TextField(blank=True, null=True)),
                ('description', cms.models.fields.HtmlField()),
                ('email_address', models.EmailField(blank=True, help_text='An email address to which applications should be sent.', max_length=254, null=True)),
